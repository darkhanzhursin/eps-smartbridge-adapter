...
import kz.ezdrav.eps_smartbridge_adapter.model.ws.eps.GetIDs;
...
@Component
public class GetIDsBuilder implements SoapMessageBuilder {

    private final String template = " is mandatory field";

    @Override
    public void buildBody(SOAPBody soapBody, Object data) throws SOAPException {
        GetIDs request = (GetIDs) data;
        SOAPElement element = soapBody.addChildElement(KaySoapConstants.GET_IDS, KaySoapConstants.KAY);
